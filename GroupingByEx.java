...
public class GroupingByEx {
	...
	public static void main(String[] args) {
		 ...
		 * "orange", "banana", "papaya"); Map<String, Long> result = items.stream()
		 ...
		 * Collectors.counting())); System.out.println(map); Map<String, Integer> sum =
		 * items.stream() .collect(Collectors.groupingBy(Item::getName,
		 * Collectors.summingInt(Item::getQty))); System.out.println(sum);
		 */
